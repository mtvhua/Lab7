...
import { searchCountries, ApiError, getCountriesByRegion } from './services/countryApi';
...
async function handleRegionChange(): Promise<void> {
  ...
  try {
    ...
    render({ status: 'error', message: 'Error al filtrar por región' });
  }
}
...
function setupEventListeners(): void {
  ...
  regionFiltro.addEventListener('change', () => {    // para el dropdown
